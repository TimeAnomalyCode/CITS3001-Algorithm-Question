...
The coded message is prefixed with digit ` 0 '. Any valid word index is appended to the coded message and must be sorted. Once all words have been appended, any valid word that ends with ` + ', the index should be added to the prefix. Additionally, the valid word that ends with ` . ', the index should be appended to the end of the coded message.
